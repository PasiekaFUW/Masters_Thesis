...
# conv.extract_data(FilePath, output_path) #extract
# conv.process_massive_csv_in_chunks(output_path, os.path.join(output_dir, 'data_all_tau_train.csv')) #then process, run twice changing comments